...
##APP_ICON_PATH = "./images/icon.ico" #GUI icon path
...
MESSAGE.set("Click Recognize to start recognition")
...
name_entry = ttk.Entry(root, textvariable=NEW_NAME, state="enabled")
name_entry.place(relx=0.97, rely=0.428,relheight=0.05,relwidth = 0.2, anchor = "ne")
name_entry.bind('<Return>', enter_name)

name_button = ttk.Button(root,text="Enter your name",command=enter_name, state="enabled")
