...
canvas = tk.Canvas(root, width=WIDTH-5, height=HEIGHT-5,bg="white")
...
message_label=tk.Label(root,textvariable=MESSAGE, wraplength = "5c", bg="white", fg="black")
...
STATE = "enabled"
name_entry = ttk.Entry(root, textvariable=NEW_NAME, state=STATE)
name_entry.place(relx=0.97, rely=0.428,relheight=0.05,relwidth = 0.2, anchor = "ne")
name_entry.bind('<Return>', enter_name)

name_button = ttk.Button(root,text="Enter your name",command=enter_name, state=STATE)
